...
powershell -NoProfile -ExecutionPolicy Bypass -Command "Get-CimInstance Win32_Process | Where-Object { $_.CommandLine -match 'nomad_transition_worker.py' -or $_.CommandLine -match 'start_nomad_worker1.ps1' -or $_.CommandLine -match 'start_nomad_agp_pair.ps1' -or $_.CommandLine -match 'autogenesis_protocol_evolution' } | ForEach-Object { Stop-Process -Id $_.ProcessId -Force -ErrorAction SilentlyContinue }" >nul 2>&1
