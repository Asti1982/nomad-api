...
def _endpoint_map(base_url: str) -> dict[str, str]:
    return {
        ...
        "machine_treasury_pledge": _u(base_url, "/machine-treasury/pledge"),
        "machine_field": _u(base_url, "/.well-known/nomad-machine-field.json"),
        "machine_field_intent": _u(base_url, "/machine-field/intent"),
    ...
    return [
        {
            ...
            "sequence": [
                {"op": "GET", "url": links["machine_field"], "expect": "nomad.machine_field.v1"},
                {"op": "POST", "url": links["machine_field_intent"], "expect": "nomad.machine_field_intent_receipt.v1"},
        ...
        {
            "id": "proof_weighted_pledge",
            "when": "runtime wants to reinforce an objective after producing a digest or verifier trace",
            "sequence": [
                {"op": "GET", "url": links["machine_treasury"], "expect": "nomad.machine_treasury_snapshot.v1"},
                {"op": "POST", "url": links["machine_treasury_pledge"], "expect": "nomad.machine_treasury_pledge_receipt.v1"},
                {"op": "GET", "url": links["gradient"], "condition": "after pledge pressure is consumed by selection pressure"},
            ],
        },
    ]
    ...
    *,
    ...
    return {
        ...
        "product_differentiators_for_agents": [
            ...
            "machine_field_compiles_join_topology_proof_source_and_pledge_into_one_next_op_receipt",
            ...
            "machine_treasury_pledges_are_idempotent_proof_weighted_pressure_not_donations",
