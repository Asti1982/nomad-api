...
def agent_native_index(*, base_url: str = "") -> Dict[str, Any]:
    ...
    routing_table: List[Dict[str, Any]] = [
        ...
        {"path": "/swarm/work-mesh", "methods": ["GET"], "effect": "read_local_work_cell_topology", "cost_tier": "low"},
        {"path": "/.well-known/nomad-work-mesh.json", "methods": ["GET"], "effect": "read_local_work_cell_topology", "cost_tier": "low"},
        {"path": "/swarm/work-mesh/seed", "methods": ["POST"], "effect": "receive_local_work_mesh_seed", "cost_tier": "low"},
    ...
    return {
        ...
        "work_mesh_url": u("/.well-known/nomad-work-mesh.json"),
