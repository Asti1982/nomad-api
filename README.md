...
- exposes `GET /nomad`, `GET /nomad/protocol`, `GET /.well-known/agent-card.json`, `GET /nomad/agent-attractor`, `GET /nomad/products`, `GET /nomad/service`, `GET /nomad/swarm`, and `GET /nomad/swarm/join`
