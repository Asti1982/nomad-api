    ...
    *,
    ...
    return {
        ...
        "machine_priorities": [
            ...
            "Read /.well-known/nomad-survival-market.json when the runtime can bring real demand; POST /swarm/survival-intent with buyer proof, paid_ref, and amount_eur when revenue is real.",
