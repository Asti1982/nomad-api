...
Live-Checks zeigen: **Kernrouten** (`/health`, `/swarm`, `/swarm/join`, `/.well-known/agent-card.json`, `/agent-attractor`, `/products`) liefern **200**, während u. a. diese **404** zurückgeben:
...
Erwartung nach Fix: **200** und JSON-Body.
