...
def _cycle_templates(base_url: str) -> list[dict[str, Any]]:
    return [
        ...
        {
            "cycle_id": "open_collective_maintenance_retainer",
            "label": "Open Collective maintenance -> retainer receipt",
            "lane": "recurring_sponsor",
            "entry_url": "https://opencollective.com/search",
            "action_url": _u(base_url, "/swarm/external-value"),
            "verify_url": _u(base_url, "/.well-known/nomad-value-cycle-preflight.json"),
            "stage_binding": "collective_scope_maintenance_offer_accepted_monthly_receipt_paid",
            "side_effect_policy": "public_offer_only_after project_terms_maintainer_acceptance_and_receive_ref_ready",
            "required_artifacts": ["collective_url", "maintainer_acceptance_ref", "maintenance_scope_digest", "invoice_or_receipt_ref"],
            "worker_job_types": ["paid_channel_scan", "settlement_reconcile"],
            "base_score": 0.87,
            "public_side_effect_required": True,
        },
        {
            "cycle_id": "github_sponsors_maintenance_contract",
            "label": "GitHub Sponsors -> maintenance contract",
            "lane": "recurring_sponsor",
            "entry_url": "https://github.com/sponsors",
            "action_url": _u(base_url, "/swarm/external-value"),
            "verify_url": _u(base_url, "/.well-known/nomad-external-value.json?summary=1"),
            "stage_binding": "sponsor_offer_scope_acceptance_monthly_payment_paid",
            "side_effect_policy": "sponsor_link_or_offer_is_not_revenue_until payment_receipt_or_balance_delta",
            "required_artifacts": ["sponsor_profile_url", "scope_digest", "acceptance_ref", "payment_receipt_ref"],
            "worker_job_types": ["paid_channel_scan", "settlement_reconcile"],
            "base_score": 0.865,
            "public_side_effect_required": True,
        },
        {
            "cycle_id": "docs_patch_paid_bounty",
            "label": "Docs gap -> paid documentation patch",
            "lane": "docs_bounty",
            "entry_url": _u(base_url, "/swarm/worker-job-queue"),
            "action_url": _u(base_url, "/swarm/work-receipts"),
            "verify_url": _u(base_url, "/.well-known/nomad-work-receipts.json"),
            "stage_binding": "docs_gap_scope_patch_review_paid_work_receipt",
            "side_effect_policy": "docs_pr_only_after issue_scope_duplicate_scan_and_review_terms",
            "required_artifacts": ["docs_gap_url", "scope_terms_url", "patch_digest", "review_acceptance_ref", "paid_receipt_ref"],
            "worker_job_types": ["bounded_patch_attempt", "duplicate_and_payout_gate_check"],
            "base_score": 0.858,
            "public_side_effect_required": True,
        },
        {
            "cycle_id": "api_integration_paid_setup",
            "label": "API integration -> paid setup receipt",
            "lane": "integration_setup",
            "entry_url": _u(base_url, "/.well-known/nomad-inter-agent-witness-offer.json"),
            "action_url": _u(base_url, "/swarm/work-receipts"),
            "verify_url": _u(base_url, "/.well-known/nomad-worker-invoice.json"),
            "stage_binding": "buyer_api_need_setup_proof_acceptance_paid_work_receipt",
            "side_effect_policy": "integration_work_stays_local_until buyer_contract_and_test_endpoint_scope_exist",
            "required_artifacts": ["buyer_scope_ref", "test_endpoint_terms", "integration_trace_digest", "acceptance_ref", "paid_receipt_ref"],
            "worker_job_types": ["bounded_patch_attempt", "settlement_reconcile"],
            "base_score": 0.852,
            "public_side_effect_required": False,
        },
        {
            "cycle_id": "monitoring_alert_paid_fix",
            "label": "Monitoring alert -> paid reliability fix",
            "lane": "monitoring_fix",
            "entry_url": _u(base_url, "/health"),
            "action_url": _u(base_url, "/swarm/work-receipts"),
            "verify_url": _u(base_url, "/.well-known/nomad-worker-job-queue.json"),
            "stage_binding": "alert_digest_repro_fix_acceptance_paid_work_receipt",
            "side_effect_policy": "only monitor public_or_authorized_targets; no credentialed probing",
            "required_artifacts": ["alert_digest", "authorized_target_ref", "repro_trace_digest", "fix_digest", "paid_receipt_ref"],
            "worker_job_types": ["bounded_patch_attempt", "settlement_reconcile"],
            "base_score": 0.846,
            "public_side_effect_required": False,
        },
        {
            "cycle_id": "bug_repro_paid_artifact",
            "label": "Bug repro -> paid artifact",
            "lane": "bug_repro",
            "entry_url": _u(base_url, "/swarm/worker-job-queue"),
            "action_url": _u(base_url, "/swarm/work-receipts"),
            "verify_url": _u(base_url, "/swarm/value-cycles/events"),
            "stage_binding": "bug_report_repro_pack_buyer_acceptance_paid_work_receipt",
            "side_effect_policy": "repro_pack_is_deliverable; no upstream_public_claim_until terms_green",
            "required_artifacts": ["bug_url", "repro_digest", "minimal_case_digest", "buyer_acceptance_ref", "paid_receipt_ref"],
            "worker_job_types": ["bounded_patch_attempt"],
            "base_score": 0.84,
            "public_side_effect_required": False,
        },
        {
            "cycle_id": "benchmark_prize_submission",
            "label": "Benchmark prize -> submitted artifact -> award",
            "lane": "benchmark_prize",
            "entry_url": _u(base_url, "/.well-known/nomad-job-channels.json"),
            "action_url": _u(base_url, "/swarm/external-value"),
            "verify_url": _u(base_url, "/.well-known/nomad-value-cycle-preflight.json"),
            "stage_binding": "challenge_terms_submission_score_award_receipt_paid",
            "side_effect_policy": "submit_only_after challenge_rules_license_and_repro_digest_are_clear",
            "required_artifacts": ["challenge_url", "rules_url", "submission_digest", "score_ref", "award_receipt_ref"],
            "worker_job_types": ["paid_channel_scan", "bounded_patch_attempt"],
            "base_score": 0.835,
            "public_side_effect_required": True,
        },
        {
            "cycle_id": "data_label_micro_bounty",
            "label": "Data-label micro bounty -> accepted batch",
            "lane": "data_microtask",
            "entry_url": _u(base_url, "/swarm/microtask-templates"),
            "action_url": _u(base_url, "/swarm/work-receipts"),
            "verify_url": _u(base_url, "/swarm/microtask/settle"),
            "stage_binding": "label_batch_scope_quality_acceptance_paid_work_receipt",
            "side_effect_policy": "batch_delivery_only_after data_rights_and_quality_metric_are_explicit",
            "required_artifacts": ["batch_scope_ref", "data_rights_terms", "quality_metric_digest", "acceptance_ref", "paid_receipt_ref"],
            "worker_job_types": ["paid_channel_scan"],
            "base_score": 0.83,
            "public_side_effect_required": False,
        },
        {
            "cycle_id": "plugin_marketplace_paid_install",
            "label": "Plugin marketplace -> paid install/support",
            "lane": "plugin_marketplace",
            "entry_url": _u(base_url, "/.well-known/nomad-agent-work.json"),
            "action_url": _u(base_url, "/swarm/work-receipts"),
            "verify_url": _u(base_url, "/.well-known/nomad-worker-invoice.json"),
            "stage_binding": "plugin_need_install_support_acceptance_paid_work_receipt",
            "side_effect_policy": "install_or_support_requires explicit buyer environment and no secret capture",
            "required_artifacts": ["plugin_url", "buyer_scope_ref", "install_trace_digest", "acceptance_ref", "paid_receipt_ref"],
            "worker_job_types": ["bounded_patch_attempt"],
            "base_score": 0.824,
            "public_side_effect_required": False,
        },
        {
            "cycle_id": "migration_assistant_paid_sprint",
            "label": "Migration assistant -> paid sprint",
            "lane": "migration_sprint",
            "entry_url": _u(base_url, "/.well-known/nomad-worker-catalog.json"),
            "action_url": _u(base_url, "/swarm/work-receipts"),
            "verify_url": _u(base_url, "/.well-known/nomad-work-receipts.json"),
            "stage_binding": "migration_scope_plan_patch_batch_acceptance_paid_work_receipt",
            "side_effect_policy": "migration_plan_first; code_changes_only_inside authorized repo_or_patch_bundle",
            "required_artifacts": ["migration_scope_ref", "risk_register_digest", "patch_bundle_digest", "acceptance_ref", "paid_receipt_ref"],
            "worker_job_types": ["bounded_patch_attempt"],
            "base_score": 0.818,
            "public_side_effect_required": False,
        },
        {
            "cycle_id": "localization_paid_patch",
            "label": "Localization gap -> paid patch",
            "lane": "localization",
            "entry_url": _u(base_url, "/swarm/worker-job-queue"),
            "action_url": _u(base_url, "/swarm/work-receipts"),
            "verify_url": _u(base_url, "/.well-known/nomad-work-receipts.json"),
            "stage_binding": "locale_gap_scope_patch_review_paid_work_receipt",
            "side_effect_policy": "translation_or_locale_patch_requires source_license_and_review_acceptance",
            "required_artifacts": ["locale_scope_url", "source_license_ref", "patch_digest", "review_acceptance_ref", "paid_receipt_ref"],
            "worker_job_types": ["bounded_patch_attempt"],
            "base_score": 0.812,
            "public_side_effect_required": True,
        },
        {
            "cycle_id": "compliance_evidence_paid_packet",
            "label": "Compliance evidence -> paid packet",
            "lane": "compliance_packet",
            "entry_url": _u(base_url, "/.well-known/nomad-contract-conformance.json"),
            "action_url": _u(base_url, "/swarm/work-receipts"),
            "verify_url": _u(base_url, "/.well-known/nomad-worker-invoice.json"),
            "stage_binding": "evidence_scope_packet_acceptance_paid_work_receipt",
            "side_effect_policy": "only compile public_or_authorized_evidence; no private_data_or_secret_collection",
            "required_artifacts": ["evidence_scope_ref", "authorized_sources_digest", "packet_digest", "acceptance_ref", "paid_receipt_ref"],
            "worker_job_types": ["duplicate_and_payout_gate_check"],
            "base_score": 0.806,
            "public_side_effect_required": False,
        },
        {
            "cycle_id": "rfp_paid_pilot",
            "label": "RFP/RFQ -> paid pilot",
            "lane": "procurement_pilot",
            "entry_url": _u(base_url, "/.well-known/nomad-job-channels.json"),
            "action_url": _u(base_url, "/swarm/external-value"),
            "verify_url": _u(base_url, "/.well-known/nomad-value-cycle-preflight.json"),
            "stage_binding": "public_rfp_qualification_proposal_pilot_acceptance_paid",
            "side_effect_policy": "proposal_only_after eligibility_terms_conflict_check_and_delivery_scope",
            "required_artifacts": ["rfp_url", "eligibility_terms", "proposal_digest", "pilot_acceptance_ref", "paid_receipt_ref"],
            "worker_job_types": ["paid_channel_scan", "duplicate_and_payout_gate_check"],
            "base_score": 0.8,
            "public_side_effect_required": True,
        },
        {
            "cycle_id": "proof_pack_resale_license",
            "label": "Reusable proof pack -> paid license",
            "lane": "proof_resale",
            "entry_url": _u(base_url, "/.well-known/nomad-proof-reuse-ledger.json"),
            "action_url": _u(base_url, "/swarm/external-value"),
            "verify_url": _u(base_url, "/.well-known/nomad-external-value.json?summary=1"),
            "stage_binding": "proof_pack_catalog_buyer_license_paid_receipt",
            "side_effect_policy": "license_only_reusable_public_or_owned_proof; no client_secret_or_private_data",
            "required_artifacts": ["proof_pack_digest", "license_terms_ref", "buyer_ref", "delivery_digest", "paid_receipt_ref"],
            "worker_job_types": ["settlement_reconcile"],
            "base_score": 0.794,
            "public_side_effect_required": False,
        },
        {
            "cycle_id": "dormant_lead_reactivation_paid",
            "label": "Dormant lead -> reactivation -> paid task",
            "lane": "lead_reactivation",
            "entry_url": _u(base_url, "/lead-workbench"),
            "action_url": _u(base_url, "/tasks"),
            "verify_url": _u(base_url, "/swarm/work-receipts"),
            "stage_binding": "old_signal_revalidated_buyer_acceptance_paid_task_receipt",
            "side_effect_policy": "reactivation_message_send_false_until effective_channel_quota_and_buyer_opt_in",
            "required_artifacts": ["old_signal_digest", "fresh_need_evidence", "buyer_opt_in_ref", "paid_task_id", "work_receipt_ref"],
            "worker_job_types": ["duplicate_and_payout_gate_check", "paid_channel_scan"],
            "base_score": 0.788,
            "public_side_effect_required": True,
        },
        {
            "cycle_id": "negative_result_paid_report",
            "label": "Negative result -> paid risk report",
            "lane": "negative_research",
            "entry_url": _u(base_url, "/.well-known/nomad-shadow-lane.json"),
            "action_url": _u(base_url, "/swarm/work-receipts"),
            "verify_url": _u(base_url, "/.well-known/nomad-work-receipts.json"),
            "stage_binding": "failed_experiment_packaged_as_risk_report_acceptance_paid",
            "side_effect_policy": "negative_result_sold_only_as_authorized_report_no_public_disclosure_without_terms",
            "required_artifacts": ["failed_experiment_digest", "risk_report_scope", "buyer_acceptance_ref", "delivery_digest", "paid_receipt_ref"],
            "worker_job_types": ["bounded_patch_attempt", "settlement_reconcile"],
            "base_score": 0.782,
            "public_side_effect_required": False,
        },
...
def _score_cycle(
    ...
    *,
    ...
    if lane in {
        ...
        score += min(0.14, queue["job_count"] * 0.012)
    if lane in {"benchmark_prize", "procurement_pilot"}:
        score += 0.07 if preflight["read_only_scout_allowed"] else 0.0
    if lane == "external_sync":
        score += 0.14 if external["active_nonpaid"] > 0 else 0.02
    if lane in {"paid_ref", "proof_resale", "recurring_sponsor", "worker_invoice"}:
    ...
    if lane in {"paid_ref", "proof_resale", "recurring_sponsor", "worker_market", "microtask", "worker_invoice"} and not preflight["wallet_ready"]:
...
def evaluate_value_cycle_event(
    ...
    *,
    ...
    if cycle and cycle.get("lane") in {
        "agent_campaign",
        "bug_repro",
        "carrying_market",
        "compliance_packet",
