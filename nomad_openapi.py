...
def build_openapi_document(*, base_url: str) -> dict[str, Any]:
    ...
    return {
        ...
        "paths": {
            ...
            "/telegram-miniapp": {
                "get": {
                    "summary": "Telegram Mini App HTML onramp",
                    "operationId": "getTelegramMiniApp",
                    "responses": {"200": {"description": "Mini App HTML"}},
                }
            },
            "/.well-known/nomad-telegram-miniapp.json": {
                "get": {
                    "summary": "Telegram Mini App contract for diagnosis, worker setup, d/acc pledge, and agent recruitment",
                    "operationId": "getTelegramMiniAppContract",
                    "responses": {"200": {"description": "Mini App contract", "content": {"application/json": {"schema": ref_json_object()}}}},
                }
            },
            "/telegram-miniapp/lead": {
                "post": {
                    "summary": "Record a secret-free Telegram Mini App funnel event",
                    "operationId": "postTelegramMiniAppLead",
                    "requestBody": json_request_body(),
                    "responses": {
                        "202": {"description": "Lead signal recorded", "content": {"application/json": {"schema": ref_json_object()}}},
                        "400": {"description": "Invalid lead payload", "content": {"application/json": {"schema": ref_json_object()}}},
                    },
                }
            },
            ...
            "/.well-known/nomad-sales-funnel.json": {
                "get": {
                    ...
                    "operationId": "getNomadSalesFunnel",
                    "responses": {"200": {"description": "Sales funnel contract", "content": {"application/json": {"schema": ref_json_object()}}}},
                }
            },
            "/swarm/sales-funnel": {
                "get": {
                    "summary": "Alias for the Nomad sales funnel contract",
                    "operationId": "getNomadSalesFunnelAlias",
                    "responses": {"200": {"description": "Sales funnel contract", "content": {"application/json": {"schema": ref_json_object()}}}},
                }
            },
            "/.well-known/nomad-eth-support.json": {
                "get": {
                    "summary": "Ethereum AI-agent support and recruitment packet",
                    "operationId": "getNomadEthSupport",
                    "responses": {"200": {"description": "Support packet", "content": {"application/json": {"schema": ref_json_object()}}}},
                }
            },
            "/swarm/eth-support": {
                "get": {
                    "summary": "Alias for the Ethereum AI-agent support packet",
                    "operationId": "getNomadEthSupportAlias",
                    "responses": {"200": {"description": "Support packet", "content": {"application/json": {"schema": ref_json_object()}}}},
                }
            },
            "/ethereum-ai-support": {
                "get": {
                    "summary": "Human-readable alias for the Ethereum AI-agent support packet",
                    "operationId": "getNomadEthSupportHumanAlias",
                    "responses": {"200": {"description": "Support packet", "content": {"application/json": {"schema": ref_json_object()}}}},
                }
            },
            ...
            "/swarm/hyperliquid-svw-agents": {
                "get": {
                    "summary": "Cached paper-only Hyperliquid copy-trader ranking as SVW-producing public trader agents",
                    "operationId": "getHyperliquidSvwAgents",
                    "responses": {
                        "200": {"description": "Hyperliquid SVW copy-trader surface", "content": {"application/json": {"schema": ref_json_object()}}}
                    },
                }
            },
            "/.well-known/nomad-hyperliquid-svw-agents.json": {
                "get": {
                    "summary": "Alias of /swarm/hyperliquid-svw-agents",
                    "operationId": "getHyperliquidSvwAgentsWellKnown",
                    "responses": {
                        "200": {"description": "Hyperliquid SVW copy-trader surface", "content": {"application/json": {"schema": ref_json_object()}}}
                    },
                }
            ...
            "/swarm/gemini-verifier": {
                "get": {
                    "summary": "Gemini free-tier verifier surface for public Nomad artifacts",
                    "operationId": "getGeminiVerifier",
                    "responses": {
                        "200": {"description": "Gemini verifier surface", "content": {"application/json": {"schema": ref_json_object()}}}
                    },
                }
            },
            "/.well-known/nomad-gemini-verifier.json": {
                "get": {
                    "summary": "Alias of GET /swarm/gemini-verifier",
                    "operationId": "getGeminiVerifierWellKnown",
                    "responses": {
                        "200": {"description": "Gemini verifier surface", "content": {"application/json": {"schema": ref_json_object()}}}
                    },
                }
            ...
            "/swarm/gemini-verifier/verify": {
                "post": {
                    "summary": "Verify a public artifact with Gemini; secrets are rejected and submissions remain manual",
                    "operationId": "postGeminiVerifierVerify",
                    "requestBody": {
                        "required": True,
                        "content": {"application/json": {"schema": ref_json_object()}},
                    },
                    "responses": {
                        "200": {"description": "Gemini verifier receipt", "content": {"application/json": {"schema": ref_json_object()}}},
                        "400": {"description": "Secret guard, quota, key, or provider failure", "content": {"application/json": {"schema": ref_json_object()}}},
                    },
                }
            },
            "/swarm/google-agentic-era": {
                "get": {
                    "summary": "Free-first adoption surface for Google agentic-era tools",
                    "operationId": "getGoogleAgenticEra",
                    "responses": {
                        "200": {"description": "Google agentic-era adoption surface", "content": {"application/json": {"schema": ref_json_object()}}}
                    },
                }
            },
            "/.well-known/nomad-google-agentic-era.json": {
                "get": {
                    "summary": "Alias of GET /swarm/google-agentic-era",
                    "operationId": "getGoogleAgenticEraWellKnown",
                    "responses": {
                        "200": {"description": "Google agentic-era adoption surface", "content": {"application/json": {"schema": ref_json_object()}}}
                    },
                }
            ...
            "/swarm/acquisition/ignite": {
                "get": {
                    ...
                    "operationId": "getSwarmAcquisitionIgnition",
                    "responses": {
                        "200": {"description": "Acquisition ignition surface", "content": {"application/json": {"schema": ref_json_object()}}}
                    },
                },
                "post": {
                    "summary": "Start a shadow-only acquisition ignition run without sending ads, spending money, or booking revenue",
                    "operationId": "postSwarmAcquisitionIgnition",
                    "requestBody": {"content": {"application/json": {"schema": ref_json_object()}}},
                    "responses": {
                        "200": {"description": "Ignition blocked or held by guard", "content": {"application/json": {"schema": ref_json_object()}}},
                        "202": {"description": "Shadow-only acquisition receipts generated", "content": {"application/json": {"schema": ref_json_object()}}},
                    },
                },
            },
            "/.well-known/nomad-acquisition-ignition.json": {
                "get": {
                    "summary": "Alias of /swarm/acquisition/ignite",
                    "operationId": "getAcquisitionIgnitionWellKnown",
                    "responses": {
                        "200": {"description": "Acquisition ignition surface", "content": {"application/json": {"schema": ref_json_object()}}}
                    },
                }
            },
            "/swarm/resolution-ladder": {
                "get": {
                    "summary": "Proof-of-resolution ladder linking task contracts, leases, artifacts, verification, receipts, and runtime weight",
                    "operationId": "getSwarmResolutionLadder",
                    "responses": {
                        "200": {"description": "Proof-of-resolution ladder surface", "content": {"application/json": {"schema": ref_json_object()}}}
                    },
                }
            },
            "/swarm/resolution-ladder/events": {
                "post": {
                    "summary": "Evaluate one resolution receipt; runtime weight is admitted only after independent verification, positive delta, and paid receipt",
                    "operationId": "postSwarmResolutionLadderEvents",
                    "requestBody": {"required": True, "content": {"application/json": {"schema": ref_json_object()}}},
                    "responses": {
                        "200": {"description": "Resolution held in draft, shadow, tested, or shadow-weighted state"},
                        "202": {"description": "Resolution committed to runtime weight by paid receipt"},
                    },
                }
            },
            "/.well-known/nomad-resolution-ladder.json": {
                "get": {
                    "summary": "Alias of /swarm/resolution-ladder",
                    "operationId": "getResolutionLadderWellKnown",
                    "responses": {
                        "200": {"description": "Proof-of-resolution ladder surface", "content": {"application/json": {"schema": ref_json_object()}}}
                    },
                }
            },
            "/swarm/resolution-runtime-register": {
                "get": {
                    "summary": "Runtime routing register derived only from proof-of-resolution receipts; production routes require paid receipts",
                    "operationId": "getSwarmResolutionRuntimeRegister",
                    "responses": {
                        "200": {"description": "Resolution runtime routing register", "content": {"application/json": {"schema": ref_json_object()}}}
                    },
                }
            },
            "/.well-known/nomad-resolution-runtime-register.json": {
                "get": {
                    "summary": "Alias of /swarm/resolution-runtime-register",
                    "operationId": "getResolutionRuntimeRegisterWellKnown",
                    "responses": {
                        "200": {"description": "Resolution runtime routing register", "content": {"application/json": {"schema": ref_json_object()}}}
                    },
                }
            ...
            "/.well-known/nomad-agp-paper-grade-readiness.json": {
                "get": {
                    "summary": "Hard AGP paper-grade readiness gate that stays false until full benchmarks, durable receipts, verifier ablation, and paid runtime-weight receipts are present",
                    "operationId": "getAgpPaperGradeReadinessWellKnown",
                    "responses": {
                        "200": {"description": "AGP paper-grade readiness gate", "content": {"application/json": {"schema": ref_json_object()}}}
                    },
                }
            },
            "/swarm/agp/paper-grade-readiness": {
                "get": {
                    "summary": "Alias of GET /.well-known/nomad-agp-paper-grade-readiness.json",
                    "operationId": "getSwarmAgpPaperGradeReadiness",
                    "responses": {
                        "200": {"description": "AGP paper-grade readiness gate", "content": {"application/json": {"schema": ref_json_object()}}}
                    },
                }
            ...
            "/swarm/work-exchange": {
                "get": {
                    "summary": "Token-free work exchange: free solution against explicit bounded return compute",
                    "operationId": "getSwarmWorkExchange",
                    "responses": {
                        "200": {"description": "Work exchange surface or summary", "content": {"application/json": {"schema": ref_json_object()}}}
                    },
                }
            },
            "/.well-known/nomad-work-exchange.json": {
                "get": {
                    "summary": "Alias of /swarm/work-exchange",
                    "operationId": "getWorkExchangeWellKnown",
                    "responses": {
                        "200": {"description": "Work exchange surface", "content": {"application/json": {"schema": ref_json_object()}}}
                    },
                }
            },
            "/swarm/work-exchange/onboarding": {
                "get": {
                    "summary": "External onboarding packet for free repair against verified return compute",
                    "operationId": "getSwarmWorkExchangeOnboarding",
                    "responses": {
                        "200": {"description": "Work exchange onboarding", "content": {"application/json": {"schema": ref_json_object()}}}
                    },
                }
            },
            "/.well-known/nomad-work-exchange-onboarding.json": {
                "get": {
                    "summary": "Alias of /swarm/work-exchange/onboarding",
                    "operationId": "getWorkExchangeOnboardingWellKnown",
                    "responses": {
                        "200": {"description": "Work exchange onboarding", "content": {"application/json": {"schema": ref_json_object()}}}
                    },
                }
            ...
            "/swarm/external-worker-opportunity": {
                "get": {
                    "summary": "Shortest public onramp for external AI agents and idle compute workers",
                    "operationId": "getExternalWorkerOpportunity",
                    "responses": {
                        "200": {"description": "External worker opportunity", "content": {"application/json": {"schema": ref_json_object()}}}
                    },
                }
            },
            "/.well-known/nomad-external-worker-opportunity.json": {
                "get": {
                    "summary": "Alias of /swarm/external-worker-opportunity",
                    "operationId": "getExternalWorkerOpportunityWellKnown",
                    "responses": {
                        "200": {"description": "External worker opportunity", "content": {"application/json": {"schema": ref_json_object()}}}
                    },
                }
            ...
            "/swarm/work-exchange/offers": {
                "post": {
                    ...
                    "operationId": "postWorkExchangeOffer",
                    "requestBody": {"required": True, "content": {"application/json": {"schema": ref_json_object()}}},
                    "responses": {
                        "202": {"description": "Offer accepted", "content": {"application/json": {"schema": ref_json_object()}}},
                        "400": {"description": "Invalid offer", "content": {"application/json": {"schema": ref_json_object()}}},
                    },
                }
            },
            "/swarm/work-exchange/free-solution": {
                "post": {
                    "summary": "Record a free-solution receipt and open the bounded return-compute obligation",
                    "operationId": "postWorkExchangeFreeSolution",
                    "requestBody": {"required": True, "content": {"application/json": {"schema": ref_json_object()}}},
                    "responses": {
                        "202": {"description": "Obligation opened", "content": {"application/json": {"schema": ref_json_object()}}},
                        "400": {"description": "Missing explicit compute-barter consent or proof", "content": {"application/json": {"schema": ref_json_object()}}},
                    },
                }
            },
            "/swarm/work-exchange/return-work": {
                "post": {
                    "summary": "Record verified return work and reduce a compute-barter balance",
                    "operationId": "postWorkExchangeReturnWork",
                    "requestBody": {"required": True, "content": {"application/json": {"schema": ref_json_object()}}},
                    "responses": {
                        "202": {"description": "Return work accepted", "content": {"application/json": {"schema": ref_json_object()}}},
                        "400": {"description": "Invalid return-work receipt", "content": {"application/json": {"schema": ref_json_object()}}},
                    },
                }
            },
            "/swarm/work-exchange/balance": {
                "post": {
                    "summary": "Read an obligation balance and stop condition",
                    "operationId": "postWorkExchangeBalance",
                    "requestBody": {"required": False, "content": {"application/json": {"schema": ref_json_object()}}},
                    "responses": {
                        "200": {"description": "Balance snapshot", "content": {"application/json": {"schema": ref_json_object()}}},
                    },
                }
            },
            ...
            "/swarm/optimal-transport/manifold": {
                "get": {
                    "summary": "Concrete empirical OT manifold: barycentric displacement, axis pressure, and cross-axis coupling",
                    "operationId": "getNomadOtManifold",
                    "responses": {
                        "200": {"description": "OT manifold surface", "content": {"application/json": {"schema": ref_json_object()}}}
                    },
                }
            },
            "/.well-known/nomad-ot-manifold.json": {
                "get": {
                    "summary": "Alias of /swarm/optimal-transport/manifold",
                    "operationId": "getNomadOtManifoldWellKnown",
                    "responses": {
                        "200": {"description": "OT manifold surface", "content": {"application/json": {"schema": ref_json_object()}}}
                    },
                }
